...
const loader = async (data) => {
  ...
  document.querySelector('.images--background').innerHTML = `
    <figure>
      <img src="https://practice-js-server.onrender.com${infoVideo.background}" alt="background">
  ...
  document.querySelector('.images--avatar').innerHTML = `
    <figure>
      <img src="https://practice-js-server.onrender.com${infoVideo.avatar}" alt="avatar">
