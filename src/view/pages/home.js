...
const homePage = () => {
  return `
    ${header()}
    <section class ="section-main-home" id = "rootApp">
     <div class="section-main-home--title">
       <h3>MaileHereko</h3>
     </div> <!-- end section-main--title --> 
     <div class="section-main-home--desc">
     ...
     <div class ="section-main-home--search">
     ...
     <div class="section-main-home--subNav">
      ...
      <p class="section-main-home--desc-subNav">ALL<span>(120)</span></p>
      <div class="section-main-home--list-movies"></div>
    </section>
    ${footer()}
    `;
};
